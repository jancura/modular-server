// modulserv.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "modulservWinService.h"

using namespace modulserv;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "modulserv.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew modulservWinService());
	}
}
